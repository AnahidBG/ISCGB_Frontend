...
export class RevisionAdministrativaComponent {
  ...
  menuItems: MenuItem[] = [
    ...
    { label: 'Mi Legajo', routerLink: '/mi-legajo', icon: 'legajo' },
    { label: 'Subir Documento', routerLink: '/subir-documento', icon: 'subir' },
    { label: 'Revisión Administrativa', routerLink: '/revision-administrativa', icon: 'revision' }
  ];
